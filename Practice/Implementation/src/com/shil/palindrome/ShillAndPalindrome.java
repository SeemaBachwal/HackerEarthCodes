...
public class ShillAndPalindrome {
	...
	public static void main(String[] args) {
		...
		System.out.println("oddnumbered char size :"+size);
		while(size>1)
		{
			size = size-2;
